...
<body>
            ...
            <div class="cart-page">
                ...
                <div class="order-summary-box">
                    ...
                    <div class="summary-row">
                        ...
                        <!-- UPDATED: Use dynamic variable from controller -->
                        <span id="summaryDelivery">₱{{ number_format($deliveryFee, 2) }}</span>
                    </div>
    ...
    <script>
        ...
        // UPDATED: Inject dynamic fee from PHP into JS
        // We use the ?? 49.00 check just in case the variable is missing to prevent JS errors
        const DELIVERY_FEE = {{ $deliveryFee ?? 49.00 }};
