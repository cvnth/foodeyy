...
@section('content')
    <div style="padding: 30px;">
        ...
        <div id="emptyState" style="text-align: center; margin-top: 50px; display: none;">
            ...
            <a href="{{ route('user.dashboard') }}" style="color: #e67e22; text-decoration: none; font-weight: 500; margin-top: 10px; display: inline-block; border: 1px solid #e67e22; padding: 8px 16px; border-radius: 4px;">
                Browse Menu
            </a>
        </div>
    </div>
    ...
    {{-- ========================================== --}}
    {{--  THE MODAL (Exact HTML you provided)       --}}
    {{-- ========================================== --}}
                    ...
                    <div class="food-details-info w-full lg:w-3/5">
                        ...
                        <div class="food-details-actions flex items-center gap-4">
                            ...
                            <div class="quantity-selector flex items-center bg-gray-100 rounded-xl border border-gray-200">
                                ...
                                <span class="quantity w-12 text-center font-bold text-lg text-gray-800" id="detailQty">1</span>
